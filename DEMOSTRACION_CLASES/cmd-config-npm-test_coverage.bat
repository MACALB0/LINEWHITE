...
REM =========================================================
REM NPM TEST:COVERAGE
REM =========================================================
echo.
echo !YELLOW!=========================================================!RESET!
echo !YELLOW!                  EJECUTANDO NPM TEST:COVERAGE                 !RESET!
echo !YELLOW!=========================================================!RESET!
echo.
...
if errorlevel 1 (
    echo.
    echo !RED!=========================================================!RESET!
    echo !RED!                 NPM TEST:COVERAGE: ERROR                      !RESET!
    echo !RED!=========================================================!RESET!
) else (
    echo.
    echo !GREEN!=========================================================!RESET!
    echo !GREEN!                NPM TEST:COVERAGE: OK                         !RESET!
    echo !GREEN!=========================================================!RESET!
)
...
echo !GREEN!=========================================================!RESET!
echo !GREEN!         coverage\lcov-report\index.html                 !RESET!
echo !GREEN!=========================================================!RESET!
